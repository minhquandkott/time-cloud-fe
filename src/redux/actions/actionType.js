...
export const FETCH_TOTAL_TIME_DAY_SELECTED_START =
  "FETCH_TOTAL_TIME_DAY_SELECTED_START";
export const FETCH_TOTAL_TIME_DAY_SELECTED = "FETCH_TOTAL_TIME_DAY_SELECTED";
export const FETCH_TOTAL_TIME_DAY_SELECTED_SUCCESS =
  "FETCH_TOTAL_TIME_DAY_SELECTED_SUCCESS";
export const FETCH_TOTAL_TIME_DAY_SELECTED_FAIL =
  "FETCH_TOTAL_TIME_DAY_SELECTED_FAIL";
export const REMOVE_TIME_SELECTED_DAY = "REMOVE_TIME_SELECTED_DAY";
export const SET_TOTAL_TIME_CURRENT_DAY = "SET_TOTAL_TIME_CURRENT_DAY";
export const SET_TOTAL_TIME_CURRENT_WEEK = "SET_TOTAL_TIME_CURRENT_WEEK";
